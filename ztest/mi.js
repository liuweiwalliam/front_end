...
(function ($) {
    if (typeof $.log === "undefined") {
        if (!$.browser.safari && typeof window.console !== "undefined" && typeof window.console.log === "function") {
            ...
            $.console = {log: $.log, debug: $.log, warn: $.log, error: alert, trace: $.log}
        }
    }
    ...
    $.extend($.LightboxClass.prototype, {
        images: {
            list: [], image: false, prev: function (image) {
        ...
        files: {
            compressed: {
                js: {lightbox: "js/jquery.lightbox.min.js", colorBlend: "js/jquery.color.min.js"},
                css: {lightbox: "css/jquery.lightbox.css"}
            },
            uncompressed: {
                js: {lightbox: "js/jquery.lightbox.js", colorBlend: "js/jquery.color.js"},
                css: {lightbox: "css/jquery.lightbox.css"}
            },
            images: {
        ...
        text: {
            ...
            download: "\u4e0b\u8f7d",
            help: {close: "\u70b9\u51fb\u5173\u95ed", interact: "\u9f20\u6807\u7ecf\u8fc7\u7684\u6548\u679c"},
            about: {
        ...
        resizeBoxes: function (type) {
            if (type !== "transition") {
                ...
                $("#lightbox-overlay").css({width: $body.width(), height: $body.height()});
                delete $body
            }
            switch (type) {
                case"general":
